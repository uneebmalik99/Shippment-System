                ...
                <div class="card-body">
                    ...
                    <div class="bodydetails">
                        ...
                        <div class="bodydetails collapse" id="state{{@$loading_country['id']}}">
                            ...
                            <div class="serial mx-3 my-4" id="state_port{{@$lState['id']}}"
                            style="background: #92c9e8;color:white; border-radius: 9px;display: flex; justify-content: space-between;" data-toggle="collapse" data-target="#state{{@$lState['id']}}">
                            <div class="num_name_section">
                            ...
                            style="background: #E7F0F5; border-radius: 9px;display: flex; justify-content: space-between;" data-toggle="collapse" data-target="#state_port{{@$lPorts['id']}}">
                            <div class="num_name_section">
                ...
                <div class="card-body">
                    ...
                    <div class="bodydetails">
                        ...
                        <div class="bodydetails collapse" id="desti_state{{@$destination_country['id']}}">
                            ...
                            <div class="serial mx-3 my-4" id="dstate_port{{@$dState['id']}}"
                            style="background: #92c9e8;color:white; border-radius: 9px;display: flex; justify-content: space-between;" data-toggle="collapse" data-target="#desti_state{{@$dState['id']}}">
                            <div class="num_name_section">
                            ...
                            @foreach(@$dState['destination_port'] as $dPorts)
                                <div class="serial mx-3"
                            style="background: #E7F0F5; border-radius: 9px;display: flex; justify-content: space-between;" data-toggle="collapse" data-target="#dstate_port{{@$dPorts['id']}}">
                            <div class="num_name_section">
                ...
                <div class="card-body">
                    ...
                    <div class="bodydetails">
                        ...
                        <div class="bodydetails collapse" id="make{{@$mms['id']}}">
                            ...
                            <div class="serial mx-3 my-4" id="make_series{{@$mModel['id']}}"
                            style="background: #92c9e8;color:white; border-radius: 9px;display: flex; justify-content: space-between;" data-toggle="collapse" data-target="#state{{@$mModel['id']}}">
                            <div class="num_name_section">
                            ...
                            @foreach(@$mModel['series'] as $mSeries)
                                <div class="serial mx-3"
                            style="background: #E7F0F5; border-radius: 9px;display: flex; justify-content: space-between;" data-toggle="collapse" data-target="#make_series{{@$lPorts['id']}}">
                            <div class="num_name_section">
