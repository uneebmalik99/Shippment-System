                ...
                <div class="card-body">
                    ...
                    <div class="bodydetails">
                        ...
                        <div class="bodydetails collapse" id="state{{@$loading_country['id']}}">
                            ...
                            margin-top: 2px !important;
                            background: #E7F0F5;" data-toggle="collapse" data-target="#state_port{{@$lPorts['id']}}">
                            <div class="num_name_section">
                ...
                <div class="card-body">
                    ...
                    <div class="bodydetails">
                        ...
                        <div class="bodydetails collapse" id="desti_state{{@$destination_country['id']}}">
                            ...
                            margin-left: 145px !important;
                            margin-top: 2px !important;
                            background: #E7F0F5;" data-toggle="collapse" data-target="#dstate_port{{@$dPorts['id']}}">
                            <div class="num_name_section">
                ...
                <div class="card-body">
                    ...
                    <div class="bodydetails">
                        ...
                        <div class="bodydetails collapse" id="make{{@$mms['id']}}">
                            ...
                            margin-left: 145px !important;
                            margin-top: 2px !important;
                            background: #E7F0F5;" data-toggle="collapse" data-target="#make_series{{@$lPorts['id']}}">
                            <div class="num_name_section">
