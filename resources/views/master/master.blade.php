            ...
            <div class="bodydetails">
                ...
                <div class="serial mx-3 my-4"
                    ...
                    <div class="button_secton" style="margin-left:19px !important">
                        <div class="option_section" style="margin-top:3px;">
                            <input style="margin-right: 5px !important" class="form-check-input status_change"
                                id="{{$titletypedata['id']}}" tab="titletype" {{$titletypedata['status']==1 ?'checked':''}}
                                type="checkbox" value="{{$titletypedata['status']}}">
            ...
            <div class="bodydetails">
                ...
                <div class="serial mx-3 my-4"
                    ...
                    <div class="button_secton" style="margin-left:19px !important">
                        <div class="option_section" style="margin-top:3px;">
                            <input style="margin-right: 5px !important" class="form-check-input status_change"
                                id="{{$shippernamedata['id']}}" tab="shippername" {{$shippernamedata['status']==1 ?'checked':''}}
                                type="checkbox" value="{{$shippernamedata['status']}}">
        ...
        <div class="card-body">
            ...
            <div class="bodydetails">
                ...
                <div class="serial mx-3 my-4"
                    ...
                    <div class="button_secton" style="margin-left:19px !important">
                        <div class="option_section" style="margin-top:3px;">
                            <input style="margin-right: 5px !important" class="form-check-input vehiclestatus_change"
                                id="{{$vehiclestatusdata['id']}}" tab="vehiclestatus" {{$vehiclestatusdata['vehiclestatus']==1 ?'checked':''}}
            ...
            <div class="bodydetails">
                ...
                <div class="serial mx-3 my-4"
                    ...
                    <div class="button_secton" style="margin-left:19px !important">
                        <div class="option_section" style="margin-top:3px;">
                            <input style="margin-right: 5px !important" class="form-check-input status_change"
                            id="{{$pickuplocationdata['id']}}" tab="pickuplocation" {{$pickuplocationdata['status']==1 ?'checked':''}}
                            type="checkbox" value="{{$pickuplocationdata['status']}}">
             ...
             <div class="bodydetails">
                 ...
                 <div class="serial mx-3 my-4"
                     ...
                     <div class="button_secton" style="margin-left:19px !important">
                         <div class="option_section" style="margin-top:3px;">
                            <input style="margin-right: 5px !important" class="form-check-input status_change"
                            id="{{$warehousedata['id']}}" tab="warehouse" {{$warehousedata['status']==1 ?'checked':''}}
                            type="checkbox" value="{{$warehousedata['status']}}">
