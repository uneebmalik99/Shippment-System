<div class="modal-header">
    ...
    <button type="button" id="close_modal" class="close" data-dismiss="modal" aria-label="Close">
        <svg width="30" height="30" viewBox="0 0 16 16" fill="none"
            ...
            <defs>
                <filter id="filter0_d_2121_78" x="0" y="0" width="16" height="16"
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix"
                        result="effect1_dropShadow_2121_78" />
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_2121_78"
                        result="shape" />
                </filter>
            </defs>
        </svg>
...
<div class="modal-body">
            ...
            <div class="input-group-append">
                <button class="add-more" type="button"
                    ...
                    <svg width="38" height="38" viewBox="0 0 38 38" fill="none"
                        ...
                        <defs>
                            <filter id="filter0_d_2121_81" x="0" y="0" width="38" height="38"
                                filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                <feColorMatrix in="SourceAlpha" type="matrix"
                                ...
                                <feBlend mode="normal" in2="BackgroundImageFix"
                                    result="effect1_dropShadow_2121_81" />
                                <feBlend mode="normal" in="SourceGraphic"
                                    in2="effect1_dropShadow_2121_81" result="shape" />
                            </filter>
                        </defs>
                    </svg>
                </button>
    ...
    <div class="modal-footer">
        <button type="button" class="btn save_btn" id="title_save">
