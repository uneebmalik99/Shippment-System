            ...
            <div class="border-style card-rounded">
                ...
                <div class="px-4 pt-2 mt-4">
                        ...
                        <div class="col-6 d-flex justify-content-end p-0">
                            ...
                            <div class="col-5 px-0 d-flex justify-content-center">
                                <button type="button"
                                    ...
                                    style="background: #696CFF;" data-target="#exampleModal" id="shipment">
                    ...
                    <div class="d-flex py-3 px-0">
                        ...
                        <div class="col-3 p-0">
                            <select class="form-control-sm border-style input-border-style rounded col-12 text-muted px-2"
                                name="author" id="author">
