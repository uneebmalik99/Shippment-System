                ...
                <div class="d-flex py-2">
                    ...
                    <div class="col-6">
                        <table class="col-12">
                            ...
                            <tr class="d-flex py-2">
                                <td class="col-4">
                                    <label for="loading_state" class="form-control border border-0"><b>State</b></label>
                                </td>
                                <td class="col-6">
                                    <input type="text" class="form-control-sm border border-0 rounded-pill bg"
                            ...
                            <tr class="d-flex py-2">
                                <td class="col-4">
                                    <label for="insurance" class="form-control border border-0"><b>Insurance</b></label>
                                </td>
                                <td class="col-6">
                                    <input type="text" class="form-control-sm border border-0 rounded-pill bg col-10"
                        ...
                        <table class="col-12">
                            ...
                            <tr>
                                <td class="col-12">
                                    <div>
                                        <textarea type="text"
                                            class="form-control-sm border border-info rounded col-12 text-dark" rows="6"
                                            name="notes" id="note"
                                            style="background: rgba(170, 219, 255, 0.35);"></textarea>
                                    </div>
                                </td>
                            </tr>
