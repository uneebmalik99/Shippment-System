<table id="towing_table" class="table scroll row-border">
    <thead class="bg-custom text-dark">
        <tr class="font-size">
            ...
            <th class="font-bold-tr">CUSTOMER PAYING</th>
            <th class="font-bold-tr">FEE</th>
            <th class="font-bold-tr">PROFIT</th>
            <th class="font-bold-tr">P DATE </th>
            <th class="font-bold-tr">PAID BY</th>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div style="vertical-align: middle">
                            <img src="{{ asset('images/user.png') }}" alt="" class="customer_image">
                        </div>
                        <div>
