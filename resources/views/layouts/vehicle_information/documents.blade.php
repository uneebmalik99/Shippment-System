                        ...
                        <div class="col-12">
                                        ...
                                        <table class="table w-100" style="color:#6D8DA6;font-size:13px;font-weight:500">
                                            ...
                                            <tbody>
                                                ...
                                                width: 33%;">
                                                        ...
                                                        <button style="background: #3e5871;color:white;border-radius:5px;outline:none;border:none;padding: 0 5px;">
                            ...
                            <div class="d-flex justify-content-between "
                                ...
                                <span class="information_text mr-5">
                                    <button style="background:#3e5871;color:white;border-radius:5px;outline:none;border:none;">Details</button>
                                </span>
                            </div>
