<div class="card user-card rounded  mt-lg-4 mt-md-4 mt-sm-4 mt-4">
    <div class="px-3 d-flex justify-cotent center">
        <h6 class="text-muted"><b>Quotation Information</b></h6>
    </div>
<form method="POST" id="customer_quotation_form" enctype="multipart/form-data" class=" mt-lg-4 mt-md-4      mt-sm-4 mt-4">
            ...
            <div>
                <select name="destination_port" id="destination_port"
                    ...
                    <option selected disabled>Destination Ports</option>
                        <option value="">Select Destination Ports</option>
                </select>
