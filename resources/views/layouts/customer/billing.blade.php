    ...
    <div class="col-12 mt-2">
        ...
        <div class="d-flex justify-content-between mt-4">
            <div class="col-4 text-left text-muted">
                ...
                <input class="form-control-sm border border-info rounded" type="text" name="last_name"
                    id="last_name">
            </div>
            <div class="col-4 text-left text-muted">
        ...
        <div>
            ...
            <div class="d-flex justify-content-start mt-2">
                ...
                <div class="text-muted d-flex col-3">
                    <input class="text-muted d-flex px-2" type="radio" name="purchased_from" id="package">
