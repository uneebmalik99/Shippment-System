                    ...
                    <div class="row">
                        <div class="col-9 ml-3">
                            ...
                            <div class="d-flex justify-content-between "
                                ...
                                <span class="information_text ">sdfsdfsd</span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between "
                                ...
                                <span class="information_text ">sdfsdfsdf</span>
                            </div>
                            <div class="d-flex justify-content-between "
                                style="border: 1px solid rgba(26, 88, 133, 0.17); border-radius: 10px;width: 90%;margin:4px auto;padding:5px;  ">
                                <span class="infromation_mainText ">Title No</span>
                                <span class="information_text ">sdfdsf</span>
                            </div>
                            <div class="d-flex justify-content-between "
                                style="border: 1px solid rgba(26, 88, 133, 0.17); border-radius: 10px;width: 90%;margin:4px auto;padding:5px;  ">
                                <span class="infromation_mainText ">Recive Date</span>
                                <span class="information_text ">sdfsd</span>
                            </div>
                            <div class="d-flex justify-content-between "
                                style="border: 1px solid rgba(26, 88, 133, 0.17); border-radius: 10px;width: 90%;margin:4px auto;padding:5px;  ">
                                ...
                                <div class="d-flex justify-content-between "
                                    ...
                                    <div class="w-100 ml-4">
                                        <table class="table w-100" style="color:#6D8DA6;font-size:13px;font-weight:500">
                                            ...
                                            <tbody>
                                                <?php $i = 1; ?>
                                                @foreach ($shipments['shipment_invoice'] as $OtherDoc)
                                                    <tr>
                                                        <td>{{ @$i }}</td>
                                                        <td>{{ @$OtherDoc['thumbnail'] }}</td>
                                                        <td
                                                            style="text-align: center;
                                                width: 33%;">

                                                            <a target="_blank" href="{{ asset(@$OtherDoc['name']) }}">
                                                            ...
                                                            <a href="{{ asset(@$OtherDoc['name']) }}" class="text-muted"
                                                                download="{{ asset(@$OtherDoc['thumbnail']) }}">
                                                                <button class="profile-button"
                                                                    style="cursor: pointer !important;">
                                                                    <svg width="16" height="14"
                                                                        ...
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path
                                                                            d="M17.5 7.5H12.5V0H5V7.5H0L8.75 16.25L17.5 7.5ZM7.5 10V2.5H10V10H11.4625L8.75 12.7125L6.0375 10H7.5ZM0 18.75H17.5V21.25H0V18.75Z"
                                                                            fill="#214986" />
                                                                    </svg>
                                                                </button>
                                                            </a>
                                                    ...
                                                    <?php $i++; ?>
                                                @endforeach
                                                @foreach ($shipments[0]['stamp_titles'] as $OtherDoc)
                                                    <tr>
                                                        <td>{{ @$i }}</td>
                                                        <td>{{ @$OtherDoc['thumbnail'] }}</td>
                                                        <td
                                                ...
                                                width: 33%;">
                                                    ...
                                                    <?php $i++; ?>
                                                @endforeach
                                                @foreach ($shipments[0]['other_documents'] as $OtherDoc)
                                                    <tr>
                                                        <td>{{ @$i }}</td>
                                                        <td>{{ @$OtherDoc['thumbnail'] }}</td>
                                                        <td
                    ...
                    <div class="information_gallary">
                        <div class="gallary_header d-flex">
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        {{-- {{ dd($shipments[0]['shipment_invoice']) }} --}}
                                        <div class="w-100 d-flex"
                                            ...
                                            <button class="img_active_button img_btn" id="vehicle_images"
                                                onclick="changeImages(this.id)" tab="{{ @$shipments[0]['id'] }}">
                                            ...
                                            <button class="image_button img_btn" onclick="changeImages(this.id)"
                                                tab="{{ @$shipments[0]['id'] }}" id="warehouse_images"
                                    ...
                                    <div class="col-12 main_image">
                                        <div class="w-100  p-3" style="position: relative;">
                                            ...
                                            <div class="left_button">
                                                ...
                                                <br>
                                                <a href="{{ asset(@$shipments[0]['shipment_invoice']['name']) }}"
                                                    download="{{ @$shipments[0]['shipment_invoice']['thumbnail'] }}"
                                ...
                                <div class="image_section">
                                    ...
                                    <div class="col-12 changeImages">
                                        @if (@$shipments[0]['shipment_invoice'])
                                            @foreach (@$shipments[0]['shipment_invoice'] as $img)
