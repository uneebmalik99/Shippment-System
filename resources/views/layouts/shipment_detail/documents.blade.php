                                ...
                                <div class="d-flex justify-content-between "
                                    ...
                                    <div class="w-100 ml-4">
                                        <table class="table w-100" style="color:#6D8DA6;font-size:13px;font-weight:500">
                                            ...
                                            <tbody>
                                                <?php $i = 1; ?>
                                                @foreach ($shipments[0]['shipment_invoice'] as $OtherDoc)
                                                    <tr>
                                                        <td>{{ @$i }}</td>
                                ...
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        {{-- <div class="w-100 d-flex"
                                            ...
                                            <button class="img_active_button img_btn" id="loading_image"
                                        ...
                                        <div class="w-100  p-3" style="position: relative;">
                                            ...
                                            <a class="bottom_button">
                                                <svg width="39" height="25" viewBox="0 0 39 25" fill="none"
                                                    ...
                                                    <defs>
                                                        <filter id="filter0_d_0_1" x="5" y="2" width="30" height="23"
                                            ...
                                            <div class="left_button">
                                                <a href="" style="text-decoration: none">
                                                    <svg width="23" height="22" viewBox="0 0 23 22" fill="none"
                                                        ...
                                                        <defs>
                                                            <filter id="filter0_d_0_1" x="1" y="2" width="20" height="20"
                                                ...
                                                <a href="" style="text-decoration: none">
                                                    <svg width="23" height="22" viewBox="0 0 23 22" fill="none"
                                                        ...
                                                        <defs>
                                                            <filter id="filter0_d_0_1" x="1" y="4" width="20" height="17"
                                                                filterUnits="userSpaceOnUse"
                                                                color-interpolation-filters="sRGB">
                                                                <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                                                <feColorMatrix in="SourceAlpha" type="matrix"
                                                ...
                                                <a href="{{@$shipments[0]['loading_image'][0]['name']}}" download="{{@$shipments[0]['loading_image'][0]['thumbnail']}}" style="text-decoration: none" id="download_shipment_image">
                                                    <svg width="23" height="23" viewBox="0 0 23 23" fill="none"
                                                        ...
                                                        <defs>
                                                            <filter id="filter0_d_0_1" x="1" y="3" width="20" height="20"
                                                                filterUnits="userSpaceOnUse"
                                                                color-interpolation-filters="sRGB">
                                                                <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                                                <feColorMatrix in="SourceAlpha" type="matrix"
