    ...
    <div class="container-fluid">
                        ...
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                                    ...
                                    <div class="col-3 p-2 d-flex justify-content-center align-items-center rounded"
                    ...
                    <div class="dashboard_boxes">
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                                    <div class="col-10 text-muted p-0 d-flex align-items-center">
                                        <div class="font-size"><span>Disable Customers</span></div>
                                    </div>
                                    <div class="col-3 p-2 d-flex justify-content-center align-items-center rounded"
                        ...
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                                    ...
                                    style="background: rgba(105, 108, 255, 0.16); !important">
                                    <img src="{{ asset('images/new_order.png') }}" alt="new order.png " style="width: 16px!important" />
                        ...
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                                    ...
                                    <div class="p-1 ml-1 d-flex justify-content-center align-items-center rounded"
                                            style="background: rgba(105, 108, 255, 0.16); !important">
                                            <img src="{{ asset('images/on_hand.png') }}" alt="on hand.png" style="width:23px!important">
                                        </div>
                                </div>
                                <div>
                        ...
                        <div class="col-12 py-0 px-1">
                            <div class="col-12 border-style card-rounded py-2 px-3">
                                <div class="d-flex">
                                    ...
                                    <div class="p-1 ml-1 d-flex justify-content-center align-items-center rounded"
                                            style="background: rgba(105, 108, 255, 0.16); !important">
                                            <img src="{{ asset('images/no_titles.png') }}" alt="no titles.png" style="width:18px!important">
                                        </div>
                                </div>
                                <div>
                                    <div class="font-bold"><span>{{@$TotalCustomers}}</span> </div>
        ...
        <div class="row mt-3">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 d-flex justify-content-center">
                <div class="dispatch_search" style="margin-left:100px">
