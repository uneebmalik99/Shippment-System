        ...
        <div class="row mb-3">
            <div class="col-12 mx-auto">
                <div class="d-flex dashboard_heading">
                    <div style="vertical-align: middle;margin-top:6px;margin-right:8px">
                        ...
                        <div class="col-12 border-style card-rounded py-2 px-3">
                            <div class="d-flex">
                                <div class="col-10 text-muted p-0 d-flex align-items-center">
                                    ...
                                    <div class="font-size"><span>Total Customers</span></div>
                                </div>
                    ...
                    <div class="col-12 py-0 px-1">
                        <div class="col-12 border-style card-rounded py-2 px-3">
                            ...
                            <div>
                                ...
                                <div class="py-1 col-12 text-muted p-0 font-size"><span>Total Customers <b>{{@$TotalCustomers}}</b></span></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-3 p-1">
                    <div class="col-12 py-0 px-1">
                        <div class="col-12 border-style card-rounded py-2 px-3">
                            <div class="d-flex">
                                <div class="col-10 text-muted p-0 d-flex align-items-center">
                                    <div class="font-size"><span>InActive Customers</span></div>
                                </div>
                                <div class="col-2 p-2 d-flex justify-content-center align-items-center rounded"
                    ...
                    <div class="col-12 py-0 px-1">
                        <div class="col-12 border-style card-rounded py-2 px-3">
                            <div class="d-flex">
                                ...
                                <div class="p-1 ml-1 d-flex justify-content-center align-items-center rounded"
                                style="background: rgba(105, 108, 255, 0.16); !important">
                                <img src="{{ asset('images/new_order.png') }}" alt="new order.png " style="width: 18px!important" />
                    ...
                    <div class="col-12 py-0 px-1">
                        <div class="col-12 border-style card-rounded py-2 px-3">
                            <div class="d-flex">
                                ...
                                <div class="p-1 ml-1 d-flex justify-content-center align-items-center rounded"
                                        style="background: rgba(105, 108, 255, 0.16); !important">
                                        <img src="{{ asset('images/posted.png') }}" alt="posted.png" style="width: 20px!important">
                    ...
                    <div class="col-12 py-0 px-1">
                        <div class="col-12 border-style card-rounded py-2 px-3">
                            <div class="d-flex">
                                ...
                                <div class="p-1 d-flex justify-content-center align-items-center rounded"
                                        style="background: rgba(105, 108, 255, 0.16); !important">
                                        <img src="{{ asset('images/dispatched.png') }}" alt="dispatched.png" style="width: 25px!important">
                    ...
                    <div class="col-12 py-0 px-1">
                        <div class="col-12 border-style card-rounded py-2 px-3">
                            <div class="d-flex">
                                ...
                                <div class="p-2 ml-1 d-flex justify-content-center align-items-center rounded"
                                        style="background: rgba(105, 108, 255, 0.16); !important">
                                        <img src="{{ asset('images/on_hand.png') }}" alt="on hand.png" style="width:20px!important">
                                    </div>
                            </div>
                            <div>
                    ...
                    <div class="col-12 py-0 px-1">
                        <div class="col-12 border-style card-rounded py-2 px-3">
                            <div class="d-flex">
                                ...
                                <div class="p-2 ml-1 d-flex justify-content-center align-items-center rounded"
                                        style="background: rgba(105, 108, 255, 0.16); !important">
                                        <img src="{{ asset('images/no_titles.png') }}" alt="no titles.png" style="width:16px!important">
                                    </div>
                            </div>
                            <div>
                                <div class="font-bold"><span>{{@$TotalCustomers}}</span> </div>
