<?php $__env->startSection('content'); ?>
    ...
    <head>
        ...
        <style>
            ...
            .image {
                background-image: url('public/images/Group 1122.png') !important;
            ...
            @media  only screen and (max-width: 600px) {
                .image {
                    background-image: url('public/images/Group 122.png') !important;
                    background-position: center !important;
                    background-size: cover !important;
                    background-repeat: no-repeat !important;
                }
                            ...
                            <div class="col-12 d-flex justify-content-center">
                                <div class="col-sm-10 col-md-8 col-lg-8">
                                    <input id="email" type="email"
                                        class="form-control col-12 border border-0 border-bottom mb-3 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
                                        name="email" value="<?php echo e(old('email'), false); ?>" required autocomplete="email"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <input id="password" type="password"
                                        class="form-control col-12 border border-0 border-bottom mb-3 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-5 mt-sm-1">
                                            <?php if(Route::has('password.request')): ?>
                                                <a class="btn-link" href="<?php echo e(route('password.request'), false); ?>">
...
<?php /**PATH C:\xampp\htdocs\TRT\Shippment-System\resources\views/auth/login.blade.php ENDPATH**/ ?>